...
screen -dmS PKT ~/packet/packetcrypt_rs/target/release/packetcrypt ann -p pkt1q72m6djqnyqmentzlrenehrv4evntcl4fppj6l5 http://pool.srizbi.com http://pool.pktpool.io http://pool.pkt.world
